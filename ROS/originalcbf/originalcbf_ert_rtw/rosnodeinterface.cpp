...
// C/C++ source code generated on : Thu Jan 08 11:18:24 2026
//
...
#define ROS_SET_RTM_ERROR_STATUS(status) originalcbf_M->setErrorStatus(status)
#define ROS_GET_RTM_ERROR_STATUS()     originalcbf_M->getErrorStatus()
#define ROS_RTM_STEP_TASK(id)          originalcbf_M->StepTask(id)
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"originalcbf\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        ROS_SET_RTM_ERROR_STATUS(NULL);
        originalcbf_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(ROS_GET_RTM_ERROR_STATUS()
                == (NULL)) || rtmGetStopRequested(originalcbf_M));
