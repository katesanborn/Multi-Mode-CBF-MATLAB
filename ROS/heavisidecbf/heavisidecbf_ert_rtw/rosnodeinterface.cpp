...
// C/C++ source code generated on : Wed Jan 07 15:46:49 2026
//
...
#define ROS_SET_RTM_ERROR_STATUS(status) heavisidecbf_M->setErrorStatus(status)
#define ROS_GET_RTM_ERROR_STATUS()     heavisidecbf_M->getErrorStatus()
#define ROS_RTM_STEP_TASK(id)          heavisidecbf_M->StepTask(id)
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"heavisidecbf\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        ROS_SET_RTM_ERROR_STATUS(NULL);
        heavisidecbf_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(ROS_GET_RTM_ERROR_STATUS()
                == (NULL)) || rtmGetStopRequested(heavisidecbf_M));
