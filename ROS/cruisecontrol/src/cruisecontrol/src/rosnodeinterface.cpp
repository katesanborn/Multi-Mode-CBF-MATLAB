...
// C/C++ source code generated on : Wed Jan 07 15:45:58 2026
//
...
#define ROS_SET_RTM_ERROR_STATUS(status) cruisecontrol_M->setErrorStatus(status)
#define ROS_GET_RTM_ERROR_STATUS()     cruisecontrol_M->getErrorStatus()
#define ROS_RTM_STEP_TASK(id)          cruisecontrol_M->StepTask(id)
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"cruisecontrol\" **\n");
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(ROS_GET_RTM_ERROR_STATUS()
                == (NULL)) || rtmGetStopRequested(cruisecontrol_M));
